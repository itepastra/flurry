...
use crate::{Canvas, Color, Command, IOProtocol, LockableCommand, Parser, Responder, Response};
        ...
        match fst {
            Ok(command) => match command {
                ...
                LOCK => self
                    .parse_locked(reader)
                    .await
                    .map(|commands| Command::Multiple(commands)),
                _ => {
...
impl<W: AsyncWriteExt + std::marker::Unpin> Responder<W> for StateParser {
