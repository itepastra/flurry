...
pub const IMAGE_SAVE_INTERVAL: Duration = Duration::from_secs(3600);
pub const JPEG_UPDATE_INTERVAL: Duration = Duration::from_millis(33);
pub const WEB_UPDATE_INTERVAL: Duration = Duration::from_millis(33);
